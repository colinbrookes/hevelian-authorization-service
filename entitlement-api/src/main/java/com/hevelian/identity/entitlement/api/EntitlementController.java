...
public class EntitlementController {
    ...
    public PrimitiveResult<String> getDecisionByAttributes(
        ...
        return new PrimitiveResult<String>(entitlementService.getDecisionByAttributes(
                attributes.getSubject(), attributes.getResource(), attributes.getAction(),
    ...
    public PrimitiveResult<Boolean> getBooleanDecision(
            @Valid @RequestBody EntitlementAttributesDTO attributes) throws ParsingException {
        return new PrimitiveResult<Boolean>(entitlementService.getBooleanDecision(
                attributes.getSubject(), attributes.getResource(), attributes.getAction(),
                attributes.getEnvironment()));
    }
}
